...
pub(crate) fn key(
    ...
    ForeignKey {
        ...
        columns: pairs
            ...
            .collect(),
        referenced_table: Some(Cow::Borrowed(referenced_table)),
...
pub(crate) fn trigger(name: &'static str) -> Trigger<'static> {
    Trigger {
        ...
        definer: Some(Cow::Borrowed("freight_owner@localhost")),
...
pub(crate) fn routine(name: &'static str) -> Routine<'static> {
    Routine {
        ...
        body: Some(Cow::Borrowed(
            "BEGIN INSERT INTO consignment (reference) VALUES (p_reference); END",
        )),
